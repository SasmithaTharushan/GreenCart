...
const MainBanner = () => {
  return (
    <div  className='relative'>
        ...
        <img src={assets.main_banner_bg_sm} alt="banner" className='w-full hidden'/>
        ...
        md:justify-center pb-24 md:pb-0 px-4 md:pl-18 lg:pl-24' >
            ...
            max-w-72 md:mx-w-80 lg:max-w-105 leading-tight lg:leading-15'
            >Freshness You’ll Love, Deals You’ll Adore! </h1>
